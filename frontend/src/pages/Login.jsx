      ...
      <div className="w-full max-w-md bg-[#121212] border border-gray-800 rounded-lg shadow-2xl p-8">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="mt-4 w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded text-sm uppercase tracking-wide transition-colors disabled:opacity-50"
          >
